...
set -l excl_mode_flags_short c $noop_flags_short
set -l excl_mode_flags_long clear $noop_flags_long
...
set -l echo_flags_short s v
set -l echo_flags_long silent verbose

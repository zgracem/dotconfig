...
complete -c tinypng -s a all-metadata -d "Copy all metadata"
complete -c tinypng -s n no-metadata -d "Discard all metadata"
...
complete -c tinypng -s V version -d "Print version"
complete -c tinypng -s h help -d "Print help"

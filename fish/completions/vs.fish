...
set -l vs_cmds help complete bundle test cleanup make media fashion build sync deploy server commit readme
...
complete -c vs -n '__fish_is_nth_token 2; and __fish_seen_subcommand_from complete' -xa 'print write'
...
complete -c vs -n '__fish_is_nth_token 2; and __fish_seen_subcommand_from media' -xa 'build source all'
complete -c vs -n '__fish_is_nth_token 2; and __fish_seen_subcommand_from build' -xa 'site fast docs json all'
complete -c vs -n '__fish_is_nth_token 2; and __fish_seen_subcommand_from sync' -xa 'all build fast docs json'
complete -c vs -n '__fish_is_nth_token 2; and __fish_seen_subcommand_from deploy' -xa 'all site fast docs json'

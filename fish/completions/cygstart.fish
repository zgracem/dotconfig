...
complete -c cygstart -l show -d 'Activate window and display it in its current size and position'
...
complete -c cygstart -l showminnoactive -d 'Display window as a minimized window'
complete -c cygstart -l showna -d 'Display window in its current state'
complete -c cygstart -l shownoactivate -d 'Display a window in its most recent size and position'

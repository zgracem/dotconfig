...
complete -c bat -s r -l line-range -d 'Only print the specified range of lines for each file'
complete -c bat -s H -l highlight-line -x -d 'Highlight the N-th line with a different background color'
complete -c bat -l color -x -d 'Specify when to use colored output'
complete -c bat -l italic-text -x -d 'Specify when to use ANSI sequences for italic text in the output'
complete -c bat -l decorations -x -d 'Specify when to use decorations specified via \'--style\''
complete -c bat -l paging -x -d 'Specify when to use the pager'
complete -c bat -l pager -x -d 'Determine which pager is used'
complete -c bat -l wrap -x -d 'Specify the text-wrapping mode'

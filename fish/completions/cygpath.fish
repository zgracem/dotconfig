...
complete -c cygpath -s u -l unix -d 'Print Unix form of NAMEs (/cygdrive/c/winnt)'
...
complete -c cygpath -s l -l long-name -d 'Print Windows long form of NAMEs' -n '__fish_seen_argument -s w -l windows; or __fish_seen_argument -s m -l mixed'
...
complete -c cygpath -s s -l short-name -d 'Print DOS/short form of NAMEs' -n '__fish_seen_argument -s w -l windows; or __fish_seen_argument -s m -l mixed'

...
set -l keys id_ed25519@{Alyx,GlaDOS,Citadel,opalstack,phosphor.pink,Pomona,vshraya} id_rsa@Juno id_zgracem@github
...
set -lx PATH $XDG_BIN_HOME $HOMEBREW_PREFIX/bin /usr/bin /bin
